...
class Paw_Template_Library_Source extends Source_Base {

	/**
	 * Template library data cache
	 */
	const LIBRARY_CACHE_ID = 'paw_library_cache';

	/**
	 * Template info api url
	 */
	const TEMPLATE_LIBRARY_API_INFO = 'http://mlimon.io/owjune/wp-json/paw/v1/library-list';

	/**
	 * Template data api url
	 */
	const TEMPLATE_LIBRARY_ITEMS_API = 'http://mlimon.io/owjune/wp-json/paw/v1/library/';

	public function get_id() {
		return 'paw-addons-library';
	}

	public function get_title() {
		return __( 'Template Library', 'paw-addons-elementor' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'paw-elementor-addons' ) );
		}
